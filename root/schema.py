...
from deliveries.schema import Query as DeliveryQuery, Mutation as DeliveryMutation
...
class Query(UserQuery, ProductsQuery, CampaignsQuery, CartQuery, PaymentQuery, DonationsQuery, DeliveryQuery,
            graphene.ObjectType):
...
class Mutation(UserMutation, ProductsMutation, CampaignMutation, CartMutation, PaymentMutation, DeliveryMutation,
               graphene.ObjectType):
